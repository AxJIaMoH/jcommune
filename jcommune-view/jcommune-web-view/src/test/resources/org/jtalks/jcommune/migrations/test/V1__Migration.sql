...
CREATE TABLE `acl_entry` (
  ...
  `ace_order` int NOT NULL,                                   -- an order of permissions priority (AccessControlEntry (ACE) represents individual permission assignment)
  `sid` bigint NOT NULL,                                      -- a link to a acl_sid table - who gets the permissions
  `mask` int NOT NULL,                                        -- bit mask, which identifies the permissions (for example for read, write etc.)
...
CREATE TABLE `acl_object_identity` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `object_id_class` bigint NOT NULL,                              -- a link to acl_class table - the type of the object
  `object_id_identity` bigint NOT NULL,                           -- an id of the object (for JCommune - the ID of the object)
  `parent_object` bigint DEFAULT NULL,                            -- a link to a parent object
  `owner_sid` bigint DEFAULT NULL,                                -- a link to a acl_sid table - the owner of the object(each object must have an owner). Pay attention if object was inherited - the fields parent_object and entries_inheriting are used to give the due details
